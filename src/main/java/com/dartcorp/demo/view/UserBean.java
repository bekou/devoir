...
public class UserBean implements Serializable
{
   ...
   @PersistenceContext(unitName = "demosample-persistence-unit", type = PersistenceContextType.EXTENDED)
  ...
  public String incUnits()
   {
      try
      {
         ...
         {
            this.user=findById(getId());
            this.user.setUnits(user.getUnits()+1);
            this.entityManager.merge(this.user);
            this.retrieve();
            return "view?faces-redirect=true&id=" + this.user.getId();
                  }
  ...
  public Long getAjout()
   {
      return this.ajout;
   }

   public void setAjout(Long ajout)
   {
      this.ajout = ajout;
   }
     
  public String incUnitVal()
   {
      ...
      try
      {
         ...
         {
            this.user=findById(getId());
            this.user.setUnits(user.getUnits()+getAjout());
            this.entityManager.merge(this.user);
            this.retrieve();
            return "view?faces-redirect=true&id=" + this.user.getId();
         }
